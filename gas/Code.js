...
function sendReportEmail(toEmail, toName, profileId, report, imageUrls) {
  try {
    ...
    const html = '<!DOCTYPE html><html><head><meta charset="UTF-8"><meta name="viewport" content="width=device-width,initial-scale=1"></head>'
      ...
      + '<tr><td style="padding:18px;border-bottom:1px solid #f0e6dd;font-weight:bold;color:#0b1730;font-size:13px;text-transform:uppercase;">Nhận định nền da</td><td style="padding:18px;border-bottom:1px solid #f0e6dd;font-size:14px;color:#0b1730;line-height:1.5;">' + formatReportText(report.skinStatus || '') + '</td></tr>'
      + imageSectionHtml
